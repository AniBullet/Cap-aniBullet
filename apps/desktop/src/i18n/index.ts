import { createContext, createEffect, createMemo, createSignal, onCleanup, onMount, type ParentProps, useContext } from "solid-js";
    ...
    const interval = setInterval(async () => {
      ...
      if (settings?.language) {
        ...
        if (settings.language !== currentLang) {
          console.log("[I18n] Language changed in store:", settings.language, "current:", currentLang);
          setLanguageSignal(settings.language as Language);
        }
      }
    }, 500);
